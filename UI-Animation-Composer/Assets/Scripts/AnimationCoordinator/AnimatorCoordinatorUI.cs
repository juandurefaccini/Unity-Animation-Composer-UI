...
namespace AnimationCreator
{
    public class AnimatorCoordinatorUI : MonoBehaviour
    {
        ...
        {
            Debug.Log("reproducir animacon cordinada");
        ...
        public void previewAnimacionCordinada()
        {
            ...
            string anim1 = "";
            if (colum1 == null)
                anim1 = GetComponentInChildren<TextMeshProUGUI>().text;  
            GameObject colum2 = columna1.GetComponent<Columna>()._ultimoBoton;
            string anim2 = "";
            if (colum2 == null)
                anim2 = GetComponentInChildren<TextMeshProUGUI>().text;  
